...
;; Meke frame transparency overridable
(defvar h4rdc0m/frame-transparency '(90 . 90))

;; The default is 800 KB. Measured in bytes.
(setq gc-cons-threshold (* 50 1024 1024))

(defun h4rdc0m/display-startup-time ()
...
(add-hook 'emacs-startup-hook #'h4rdc0m/display-startup-time)
...
;; NOTE: If you ewant to move everything out of the ~/.emacs.d folder
;; relliably, set `user-emacs-directory` before loading no-littering!
...
(setq auto-save-filename-transforms
...
(set-frame-parameter (selected-frame) 'alpha h4rdc0m/frame-transparency)
(add-to-list 'default-frame-alist `(alpha . ,h4rdc0m/frame-transparency))
...
(defun h4rdc0m/lsp-mode-setup ()
  (setq lsp-headerline-breadcrumb-segments '(path-up-to-project file symbols))
  (lsp-headerline-breadcrumb-mode))

(use-package lsp-mode
  :commands (lsp lsp-deferred)
  :hook (lsp-mode . h4rdc0m/lsp-mode-setup)
  :init
